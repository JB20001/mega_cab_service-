        ...
        <div class="card">
            ...
            <div id="vehicleList">
                <div class="vehicle-item">
                    <i class="fas fa-motorcycle"></i> <!-- TukTuk icon -->
                    <div>
        ...
        <div class="card">
            ...
            <div id="feedbackList">
                <div class="feedback-item">
                    <p><strong>John Doe:</strong> Great service! The driver was very professional.</p>
                    <p class="rating">★★★★★</p>
                </div>
                <div class="feedback-item">
                    <p><strong>Jane Smith:</strong> The cab was clean and arrived on time.</p>
                    <p class="rating">★★★★☆</p>
                </div>
                <div class="feedback-item">
                    <p><strong>Alice Johnson:</strong> Excellent experience! Highly recommend.</p>
                    <p class="rating">★★★★★</p>
                </div>
